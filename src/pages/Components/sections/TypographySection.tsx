...
import { Flex, HeadingUnits, Typography } from "../../../../lib/main";
    ...
    <Flex align="start" justify="start" gap="xl">
      ...
      >
        ...
        <Paragraph>
          ...
          text into a new line. This is an example for a 'Sampled UI' paragraph
          component that has a maximum width of 70 characters that, when
          exceeded, will break the text into a new line.
        </Paragraph>
